...
def generate_farm_qr_url(ma_vung: str, base_url: str = "http://localhost:8000") -> str:
    """
    ...
    Returns:
        str: Full URL for QR code
    """
    return f"{base_url}/trace/{ma_vung}"


def generate_farm_qr_code(ma_vung: str, base_url: str = "http://localhost:8000") -> BytesIO:
    """
